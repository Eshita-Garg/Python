...
btn_one = tk.Button(root, text="(", command=lambda: add_to_calculation("("), width=5, font=("Arial", 14))
btn_one.grid(row=4, column=1)
btn_end = tk.Button(root, text=")", command=lambda: add_to_calculation(")"), width=5, font=("Arial", 14))
btn_end.grid(row=4, column=3)
...
btn_equal = tk.Button(root, text="Enter", command=evaluate_calculation, width=11, font=("Arial", 14))
